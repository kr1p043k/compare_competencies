...
class SkillValidator:
    ...
    DEFAULT_BLACKLIST = {
        # SOFT SKILLS и бизнес-фразы (исключаем полностью)
        ...
        "исполнительность", "дисциплинированность", "пунктуальность", "целеустремленность",
        "лидерство", "лидер", "стратегия", "креативность", "инновация",
        "организованность", "надежность", "честность", "влиятельность", "уверенность",
        "дипломатичность", "пунктуален", "коммуникация", "аналитическое мышление", "bb продажи", "продажи",
"командой", "1c зарплата и управление персоналом", "1c зарплата",
"управление персоналом", "работа в команде", "работа с командой",
"команде", "командная работа", "навыки межличностного общения",
"межличностное общение", "мотивация персонала", "стратегическое мышление",
"клиентоориентированность", "ориентация на результат", "продвижение бренда",
"развитие продаж", "традиционная розница", "собственная розница",
"бухгалтерская отчетность", "бухгалтерский учет", "управление временем",
"тайм-менеджмент", "стрессоустойчивость", "ответственность",
"исполнительность", "дисциплинированность", "пунктуальность",
"целеустремленность", "лидерство", "лидер", "стратегия", "креативность",
"инновация", "организованность", "надежность", "честность",
"влиятельность", "уверенность", "дипломатичность", "пунктуален",
        ...
        "и т.д.", "и т.п.", "и др.", "и проч.", "etc", "и другие",
        ...
        "ы управления", "управления jira", "опыт построения",
        "разработчика уровня middle+ senior", "задачи в jira",
        "git soft skills проактивность", "requestslimits", "concurrencymultithreading",
        "profiling and monitoring", "background tasks", "filtering. понимание gil",
        ...
        "kari", "wildberries", "ozon", "evrone", "schaeffler", "lerna", "skillbox",
        "geekbrains", "yandex", "google", "microsoft", "apple", "samsung", "huawei",
        "burger king", "gloria jeans", "land rover", "jaguar", "nordstar", "artplay",
        "coursera", "aliexpress", "instagram", "telegram", "discord", "youtube",
        "яндекс", "гугл", "вконтакте", "одноклассники", "авито", "юла", "ситимобил",
        "иван", "петр", "сергей", "алексей", "андрей", "дмитрий", "максим", "александр","хорошее", "хороший", "отличное", "принципов", "основ", "понимание", "знание", "умение",
        "хорошее знание", "понимание принципов", "эмуляция и симуляция", "проектирование", 
"ozon офис", "ozon", "wildberries", "mimo", "mavlink", "custdev",
"командой", "решений", "чем", "предстоит", "заниматься", "управлять", "rnd",
"техническая поддержка пользователей", "поддержка пользователей"
    }
    ...
    GENERIC_WORDS = {
        ...
        "базы данных", "database", "version control",
        "linux", "windows", "macos",
    ...
    "стеком", "стека", "технологиями", "технологии",        "аналоги", "оформление", "основе", "спорт", "нас", "новых",
        "продвинутый", "области", "заниматься", "выполнения", "качества",
        "вам", "задач", "если", "развития", "базовые", "настраивать",
        "нам", "существующих", "анализа", "основные", "обработки", "внедрять",
        "технической", "готовность", "скидки", "предстоит", "наличие",
        "занимается", "создаем", "официальное", "информации", "профессионального",
        "проведения", "настройки", "соответствии", "дмс", "числе", "передовые",
        "создания", "внедрения", "формирование", "участвовать", "ищем",
        "практический", "возможности", "высшее",         "senior", "middle", "junior", "уверенный", "уровня", "разработчика",
        "опыт", "знание", "умение", "владение", "навык", "работа",
        "задачи", "влияние", "продукт", "product", "roadmap", "influence",
        "и другие", "и т.д.", "и т.п.", "etc", "cleanarchitecture",
        "проактивность", "soft skills", "hard skills"
    ...
    "иван", "петр", "сергей", "алексей", "андрей", "дмитрий", "максим", "александр",
        "реализация", "над", "проводить", "чем", "чтобы", "также", "более",
    "очередями", "рамках", "поддерживать", "сложных", "разрабатывать",
    "внешними", "которые", "есть", "продукта", "которая", "компания", "через", "коммуникация", "аналитическое мышление", "продажи", "командой",
"управление персоналом", "бухгалтерия", "тестирование на проникновение ии"
    }
    ...
    def __init__(
        ...
        whitelist: Optional[Set[str]] = load_it_skills,
        min_length: int = 3,
        max_length: int = 50,
        max_words: int = 6,
