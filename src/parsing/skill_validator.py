...
class SkillValidator:
    ...
    DEFAULT_BLACKLIST = {
        ...
        "ы управления", "управления jira", "опыт построения", "знание", "умение", "работать с", 
        "уверенный senior",
        "разработчика уровня middle+ senior",
        "задачи в jira",
        "full outer",
        "influence product roadmap",
        "cleanarchitecture и другие",
        "reciprocal rank fusion embedding",
        "технического handover от друго",
        "git soft skills проактивность",
        "requestslimits",
        "concurrencymultithreading",
        "profiling and monitoring",
        "background tasks",
        "filtering. понимание gil",
        "аналитическими функциями rank",
        "записями insert",
        "процедуры в airflow",
        "ов airflow",
        "ми transformers",
        "conversational-",
        "document understanding. оп",
        "экосистемы библиотек go",
        "logrus +viper",
        "error budget",
        "toil reduction",
        "circuit breakers",
